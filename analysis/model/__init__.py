...
def apply_model_patches(
    ...
    :param rush_ceilings_mw: Generation and storage hard ceilings in MW where build above the
        allowances is priced by the pipeline rush charge; ``None`` makes the allowances hard caps.
