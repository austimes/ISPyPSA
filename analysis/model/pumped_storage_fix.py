...
def apply(ispypsa_tables: dict, config=None) -> dict:
    ...
    generators set. After this fix, Borumba is a battery rather than a
    ...
    ispypsa_tables["custom_constraints_lhs"] = (
        _drop_pumped_storage_from_constraints_lhs(
...
def _drop_pumped_storage_from_generators(
...
def _append_pumped_storage_to_batteries(
    ...
    specs_in_scope = [
        spec
        for spec in _PUMPED_STORAGE_SPECS
