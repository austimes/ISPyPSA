...
def tidy_frame(exports: Path) -> pd.DataFrame:
    ...
    :return: Trajectory and pressure keys, delivered energy, both emissions intensities, cost and
        ...
        per-carrier energy delivered, per-fuel input intensities and storage power, for the
        campaign's base chains. Increment-grid branches have their own section instead.
    """
    results = base_rows(
