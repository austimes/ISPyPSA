...
| [`aemo_scenario_cost/`](aemo_scenario_cost/) | Per-year AEMO scenario cost excluding fuel and emissions the dashboard draws as a sanity reference | [`aemo_scenario_cost.png`](aemo_scenario_cost/aemo_scenario_cost.png) |
