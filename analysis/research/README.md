...
|---|---|---|
| [`demand_plan/`](demand_plan/) | The Step Change demand knots, 2026 to 2060, and the measured generation-to-operational-demand factor | [`demand_trajectories.png`](demand_plan/demand_trajectories.png) |
...
| [`build_rate_premium/`](build_rate_premium/) | What new capacity should cost above AEMO's planned five-year build rate | [`build_rate_premium.png`](build_rate_premium/build_rate_premium.png) |
| [`near_term_pipeline/`](near_term_pipeline/) | How much genuinely new capacity the model may add by 2030 beyond the committed pipeline | [`near_term_pipeline.png`](near_term_pipeline/near_term_pipeline.png) |
| [`pre2030_rush_charge/`](pre2030_rush_charge/) | What 2030 new build above the near-term allowance pays, from ShARP's short-lead-time charge | [`pre2030_rush_charge.png`](pre2030_rush_charge/pre2030_rush_charge.png) |
