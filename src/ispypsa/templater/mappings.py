...
_ECAA_GENERATOR_NEW_COLUMN_MAPPING = {
    ...
    # in the workbook to reach instead, so the class labels mean "these are
    # listed individually" and the per-station join is the intended mapping.
    # Seed from the generator name like the other Power-Station-keyed lookups
    # above; thermal is unaffected because its summary cell already held that
    # same station name.
