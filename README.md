...
An open-source capacity expansion modelling tool based on the methodology and assumptions used by the Australian Energy
Market Operator (AEMO) to produce their Integrated System Plan (ISP). Built on [PyPSA](https://github.com/pypsa/pypsa).

**This README is a quick reference.** For detailed instructions, tutorials, and API documentation, see the
[full documentation](https://open-isp.github.io/ISPyPSA/):
...
For the CSIRO ShARP electricity supply campaign built on top of this package, see
...
Interested in contributing to the source code or adding table configurations? Check out the
[contributing instructions](./CONTRIBUTING.md), which also includes steps to install `ispypsa` for development.
...
`ispypsa` was created as a part of the [OpenISP project](https://github.com/Open-ISP). It is licensed under the terms of
[GNU GPL-3.0-or-later](LICENSE) licences.
